...
Бейзлайн и датасет взяты из научной статьи: Hannousse, A., & Yahiouche, S. (2020). "Towards benchmark datasets for machine learning based website phishing detection".

    ВНИМАНИЕ: Файл data/dataset_phishing.csv содержит сырые URL-адреса реальных фишинговых сайтов. Не открывайте эти ссылки в браузере. Они предоставлены исключительно для обучения модели машинного обучения. Будьте осторожны.
